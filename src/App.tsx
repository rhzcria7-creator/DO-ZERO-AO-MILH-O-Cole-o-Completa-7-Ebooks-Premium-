...
export default function App() {
  ...
  // Roteamento simples com Lazy Loading (Code Splitting)
  if (path === "/checkout") {
    return (
      <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center text-gold-400">Carregando...</div>}>
        <Helmet>
          <title>Pagamento Seguro | Do Zero ao Milhão</title>
  ...
  if (path === "/sucesso" || window.location.search.includes("session_id")) {
    return (
      <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center text-gold-400">Carregando...</div>}>
        <Helmet>
          <title>Compra Concluída! | Do Zero ao Milhão</title>
          <meta name="robots" content="noindex, nofollow" />
        </Helmet>
        <SuccessPage />
      </Suspense>
  ...
  return (
    <>
      <Helmet>
        <title>Ebook Do Zero ao Milhão | Domine Suas Finanças</title>
        <meta name="description" content="Aprenda o passo a passo para sair do zero e construir riqueza. Estratégias práticas e validadas para transformar sua vida financeira." />
        <meta property="og:title" content="Ebook Do Zero ao Milhão | Domine Suas Finanças" />
        <meta property="og:description" content="Aprenda o passo a passo para sair do zero e construir riqueza. Plataforma oficial de venda." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={window.location.origin} />
        <meta property="og:image" content={`${window.location.origin}/cover.png`} />
